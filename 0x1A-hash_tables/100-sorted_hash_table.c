 ...
 *
 * Return: A pointer to the new sorted hash table. If an error occurs - NULL.
 *
 */
 ...
 *		Otherwise If the key cannot be matched - NULL
 */
...
/**
 * shash_table_print - A funtion that prints a sorted hash table in order.
 * @ht: A pointer to the sorted hash table.
 *
 */
...
/**
 * shash_table_print_rev - A function that prints a
